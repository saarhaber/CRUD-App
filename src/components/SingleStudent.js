                ...
                <div className="surroundTableSingle">
                    <table className = "singlestudentTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <p className="cpname">{this.state.student.campus ? <div> Attends: {this.state.student.campus.name} <Link className="viewButton" to={`/campus/${this.state.student.campus.id}`}>View</Link></div>: ("Not Attending a College")}</p>
                            </td>
                            <td>
