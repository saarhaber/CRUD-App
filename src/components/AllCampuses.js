            ...
            {campuses.map(campus => 
                <div>
                  <table className = "AcampusTable">
                    <tr className="topBar">
                    <img src={campus.imageUrl} width="75" height="75"></img><th className="campusName">{campus.name}</th><td><button className ="remove" onClick={() => removeCampus(campuses, campus.id)}>x</button></td>
                    </tr>
